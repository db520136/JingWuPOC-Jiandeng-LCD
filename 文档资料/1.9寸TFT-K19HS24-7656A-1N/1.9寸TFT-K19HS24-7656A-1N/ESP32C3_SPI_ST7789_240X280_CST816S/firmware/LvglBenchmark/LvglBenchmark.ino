...
public:
  LGFX(void)
  {
    ...
    {                                      // 表示パネル制御の設定を行います。
      ...
      cfg.memory_height = 296;  // ドライバICがサポートしている最大の高さ
      cfg.panel_width = 240;    // 実際に表示可能な幅
      cfg.panel_height = 296;   // 実際に表示可能な高さ
...
static const uint32_t screenHeight = 296;
